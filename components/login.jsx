...
const TriviaGameScreen = () => {
    ...
    return (
        <>
            <View flex={1} backgroundColor={'#d8ffb1'} h={'100%'} justifyContent={'center'} paddingHorizontal={'$8'}>
                <SafeAreaView>
                    ...
                    <Animated.View style={[{opacity: fadeAnim, transform: [{scale: scaleAnim}]}]}>
                        ...
                        <Text fontSize={18} color={'#1c1c1c'} mt={'$2'} textAlign={'center'}>
                    ...
                    <Animated.View style={[{opacity: fadeAnim}]}>
                        <Button backgroundColor="#1c1c1c" color={"#fff"} size="$6" mt={'$6'} iconAfter={<Ionicons name="arrow-forward-circle" size={32} color="#FFFFFF"/>}
